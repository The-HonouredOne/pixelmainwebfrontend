...
const CreateIndustry = ({ onBlogCreated }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      setLoading(true);
      const res = await axios.post("https://pixelmainwebbackend.onrender.com/api/industries", formDataToSend, {
        headers: {
      ...
      console.log("✅ Industry created:", res.data);
      setMessage("Industry created successfully!");
      setFormData({ name: "",  description: "", image: null });
      onBlogCreated && onBlogCreated(res.data.industry);
    } catch (err) {
      console.error("❌ Error creating Industry:", err.response || err);
  ...
  return (
    ...
    >
      <h2 className="text-xl font-semibold text-gray-700 mb-2">Add New Industry</h2>
      ...
      >
        {loading ? "Uploading..." : "Create Industry"}
      </button>
